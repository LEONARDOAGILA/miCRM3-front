...
import { AppAgGridService } from '../../../../../../app/service/app-agGrid.service';
import { ProductoService } from '../../../../inventarios/services/producto.service';
import { LoadingService } from '../../../../../service/loading.service';
import { firstValueFrom } from 'rxjs';
import { ProductoModel } from '../../../../inventarios/interfaces/productoModel';
...
export class AllProductosComponent implements OnInit {
  ...
  async listProductos() {
    try {
      ...
      let res: any = await firstValueFrom(this._productoService.listProductos());
