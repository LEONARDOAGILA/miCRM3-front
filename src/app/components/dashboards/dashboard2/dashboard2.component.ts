...
/**
 * Copia standalone de modules/demo/pages/dashboard2.
 *
...
@Component({
  ...
  imports: [
    ...
    CalendarModule       // <mwl-calendar-month-view>
  ],
  providers: [
    // Un componente standalone no admite CalendarModule.forRoot() en sus
    // imports, así que se replica aquí lo que forRoot() provee: el adaptador
    // de fechas y las cuatro clases de utilidad del calendario. Sin esto la
    // vista de mes falla con NG0201 al pedir DateAdapter.
